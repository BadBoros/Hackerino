...
class hackerino_customize
{
    ...
    public static function register($wp_customize)
    {
        ...
        $wp_customize->add_section(
            'hackerino_options',
            array(
                'title'       => __('hackerino Options', 'hackerino'), //Visible title of section
                'priority'    => 35, //Determines what order this appears in
                'capability'  => 'edit_theme_options', //Capability needed to tweak
                'description' => __('Allows you to customize some example settings for hackerino.', 'hackerino'), //Descriptive tooltip
            )
        );
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control( //Instantiate the color control class
            ...
            array(
                'label'      => __('Secondary Color', 'hackerino'), //Admin-visible name of the control
        ...
        function hackerino_sanitizer($sanitizrfunc)
        {
        ...
        $wp_customize->add_setting('show_header_center', array(
            ...
            'sanitize_callback' => 'hackerino_sanitizer', // Sanitize input
        ));
        ...
        $wp_customize->add_control(
            new WP_Customize_Control(
                ...
                'show_header_center',
                array(
                    'label'     => __('Text Alignment Center', 'hackerino'),
                    'section'   => 'colors',
...
add_action('customize_register', array('hackerino_customize', 'register'));

// Output custom CSS to live site
add_action('wp_head', array('hackerino_customize', 'header_output'));

// Enqueue live preview javascript in Theme Customizer admin screen
add_action('customize_preview_init', array('hackerino_customize', 'live_preview'));
